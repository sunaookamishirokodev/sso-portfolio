        ...
        <div className="flex flex-col">
            ...
            <OtpInput
                ...
                renderInput={({ className, style, ...props }, index) => (
                    <input
                        className="size-full aspect-square rounded-xl border text-center text-xl"
                        key={index}
                        {...props}
                    />
                )}
                ...
                {method === "email" ? (
                    <button
                        ...
                        className={`px-5 py-2 transition-colors ${
                            !countdown ? "bg-gray-400 hover:bg-gray-500 text-white " : "bg-gray-400/50 text-white/50"
                        }`}
                    >
